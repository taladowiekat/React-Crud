      ...
      {users.length>0 ?
        users.map((user)=>{
          ...
          <tr>
            ...
            <td>{user.email}</td>
            <td>{user.password}</td>
            <td className='btn btn-danger' onClick={()=>deletUser(user._id)}>delete</td>
            <td className='btn btn-info'><Link to={`/users/${user._id}`}>details</Link></td>
            <td className='btn btn-warning' onClick={()=>deletUser}>
