...
<Input e={errors} type={'text'} id={'username'} value={user.name} title={'user name'} name={'name'} handelData={changeData}/>
<Input e={errors} type={'email'} id={'email'} value={user.email} title={'user email'} name={'email'} handelData={changeData}/>
<Input e={errors} type={'password'} id={'userpassword'} value={user.password} title={'user password'} name={'password'} handelData={changeData}/>
  <div className="mb-3" >
